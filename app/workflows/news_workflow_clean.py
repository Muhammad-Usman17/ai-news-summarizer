...
class NewsStreamUpdate(BaseModel):
    """Model for streaming news updates without database dependencies."""
    job_id: str
    status: str
    message: str
    progress: float
...
class DailyNewsWorkflow:
    ...
    async def process_daily_news(self, schedule_date: str) -> Dict[str, Any]:
        ...
        job_id = f"daily_{schedule_date}_000000"
...
@activity.defn
async def scrape_news_clean(job_id: str) -> Dict[str, Any]:
    """
...
@activity.defn
async def summarize_news(articles: List[Dict[str, Any]], job_id: str) -> Dict[str, Any]:
    """
...
@activity.defn
async def analyze_news(summaries: List[Dict[str, Any]], job_id: str) -> Dict[str, Any]:
    """
...
async def stream_update(update: NewsStreamUpdate) -> None:
    ...
    # Convert to the main model format for Redis
    from app.models.news import NewsStreamUpdate as MainNewsStreamUpdate
    
    main_update = MainNewsStreamUpdate(
    ...
    await client.publish_update(main_update)